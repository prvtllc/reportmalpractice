...
const About = center => (
  <Layout>
    ...
    <Container center={center}>
      <h3>
        The purpose of this website is to create an environment of fairness, transparency and accountability for medical patients and to raise awareness of the behavior of those entrusted with our health. 
